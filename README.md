<div align="center">
  ...
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=3500&color=58A6FF&center=true&vCenter=true&multiline=false&lines=PythonAvrely;A+collection+of+scripts+and+mini-projects;by+Vladislav+Avrely" alt="Typing SVG" />
...
> **О репозитории** моя личная коллекция полезных скриптов и мини-проектов. Здесь собрано всё, что не требует отдельного репозитория, но слишком ценно, чтобы просто лежать в папке на компьютере.

## ✨ Особенности

- ✅ Всё в одном месте — легко найти и использовать
