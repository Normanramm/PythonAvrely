...
# Работа над ошибкой(Но ведь ключ должен быть логином, 
# а значение — паролем. Если ввести login и letpy — 
# то цикл действительно не завершится.)

book = {
    "letpy": "1984",    # Логин и пароль
    "admin": "password" # Второй логин и пароль
}
